<template>
    <div class="checkout">
        <v-container fluid class="ma-0 pa-0">
            <v-row>
                <v-col cols="7">
                    <v-card class="w-100" color="white" elevation="0" style="padding: 60px 120px 0px 40px;">
                        <v-card-title class="font-weight-bold py-0">new-ella-market</v-card-title>
                        <v-breadcrumbs :items="['Cart', 'Information']" style="font-size: 13px">
                            <template v-slot:divider>
                                <v-icon color="#878484">mdi-chevron-right</v-icon>
                            </template>
                        </v-breadcrumbs>
                        <v-card-actions class="justify-space-between align-center  mb-5">
                            <v-btn color="blue" variant="elevated" class="flex-grow-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="42" fill="white"
                                    preserveAspectRatio="xMidYMid" viewBox="0 0 341 80.035" title="Shop Pay"
                                    class="P3VGi" style="fill: white;">
                            ...
                            <v-btn color="black" variant="elevated" class="flex-grow-1">
                                <svg height="17" width="42" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <select name="" id="" class="pa-3 mt-4 w-100" style="
                                width: 55%;
                        ...
                        <div class="user_name d-flex align-center justify-center w-100" style="gap:10px;">
                            <input type="text" class="pa-3 mt-4" style="
                                width: 100%;
                                border: 1px solid black;
                                border-radius: 10px;
                                font-size: 14px;
                        ...
                        <div class="city_parent d-flex align-center justify-center" style="gap:10px;">
                            <input type="text" class="pa-3 mt-4" style="
                                width: 100%;
                                border: 1px solid black;
                                border-radius: 10px;
                        ...
                        <v-card-actions class="justify-end my-7">
                            <v-btn variant="elevated" color="blue" class="text-white" height="45" width="150" @click="dialog=true">Submit</v-btn>
                        </v-card-actions>
                        ...
                        <v-card-text style="font-size: 10px;color: #777777;">
                            All right reserved new demo
                        </v-card-text>
                    </v-card>
                </v-col>
                <v-col cols="5">
                    <v-card color="grey-lighten-3" elevation="0" width="100%" style="padding: 60px 120px 0px 40px;">
                        <v-card elevation="0" color="transparent" v-for="item in cartItems" :key="item" width="100%"
                            ...
                            <div class="title-parent flex-grow-1">
                                <v-card-title style="font-size:14px;
                                    ...
                                    color: #484848;
                                    white-space: pre-wrap;
                                    line-height: 1.2;" class="py-0">
                                    ({{ item.title }}) Sample-{{ item.category }}
                                </v-card-title>
                                <v-card-text style="font-size:12px;
                                    color: #777777;
                                    white-space: pre-wrap;">{{ item.category }}</v-card-text>
                            </div>
                        ...
                        <v-divider length="100%" color="black"></v-divider>
                        <v-card-text
                            class="d-flex align-center justify-space-between font-weight-bold"><span>Total</span><span>${{
                                calcTotalPrice }}</span></v-card-text>
                    </v-card>
                </v-col>
            </v-row>
        </v-container>
