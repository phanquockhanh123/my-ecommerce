        ...
        <v-col>
          <div class="parent d-flex align-center justify-center">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shipping-fast" role="img"
              ...
              class="svg-inline--fa fa-shipping-fast fa-w-20 fa-3x mr-5" style="width: 30px">
        ...
        <v-col>
          <div class="parent d-flex align-center justify-center second">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="award" role="img"
              ...
              class="svg-inline--fa fa-award fa-w-12 fa-3x mr-5" style="width: 30px">
              <path fill="currentColor"
        ...
        <v-col>
          <div class="parent d-flex align-center justify-center">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trophy-alt" role="img"
              ...
              class="svg-inline--fa fa-trophy-alt fa-w-18 fa-3x mr-5" style="width: 30px">
              <path fill="currentColor"
